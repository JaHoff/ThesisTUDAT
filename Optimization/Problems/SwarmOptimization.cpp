...
{
    // large-scale optimisation bounds: {-1500.e3, -1500.e3, -100.e3,-20, -20., -20.}
    std::vector<double> lowerbounds = {-1500.e3, -1500.e3, -100.e3,-20, -20., -20.}; //
    std::vector<double> upperbounds = {-1500.e3, -1500.e3, -100.e3, -20, -20., -20.};
