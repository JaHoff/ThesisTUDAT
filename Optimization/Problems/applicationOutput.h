#ifndef SWARM_OPTIMIZATION_APPLICATIONOUTPUT_H
#define SWARM_OPTIMIZATION_APPLICATIONOUTPUT_H
        ...
        const std::string& extraDirectory = "" )
{
    ...
    std::string outputPath = reducedPath + "SimulationOutput/Optimization/";
    if( extraDirectory != "" )
    {
...
#endif // SWARM_OPTIMIZATION_APPLICATIONOUTPUT_H
